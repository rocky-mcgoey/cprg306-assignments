...
export default function NewItem({ onAddItem }) {
  ...
  return (
    <section className="max-w mx-auto mt-8 p-6 rounded-xl border-2 shadow-md bg-white-100 border-black-300 text-gray-800 dark:bg-stone-900 dark:border-teal-600 dark:text-teal-300">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mt-1">Allowed range: 1-20</p>
        </div>
        <div>
